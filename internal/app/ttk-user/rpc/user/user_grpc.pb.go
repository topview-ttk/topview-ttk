...
const (
	...
	SsoService_GoogleLogin_FullMethodName               = "/user.SsoService/GoogleLogin"
	SsoService_FacebookLogin_FullMethodName             = "/user.SsoService/FacebookLogin"
	SsoService_GithubLogin_FullMethodName               = "/user.SsoService/GithubLogin"
	SsoService_StandbyGoogleLogin_FullMethodName        = "/user.SsoService/StandbyGoogleLogin"
	SsoService_StandbyFacebookLogin_FullMethodName      = "/user.SsoService/StandbyFacebookLogin"
...
func (c *ssoServiceClient) GoogleLogin(ctx context.Context, in *ThirdPartyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, SsoService_GoogleLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ssoServiceClient) FacebookLogin(ctx context.Context, in *ThirdPartyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, SsoService_FacebookLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ssoServiceClient) GithubLogin(ctx context.Context, in *ThirdPartyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
...
func (c *ssoServiceClient) StandbyGoogleLogin(ctx context.Context, in *StandbyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, SsoService_StandbyGoogleLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ssoServiceClient) StandbyFacebookLogin(ctx context.Context, in *StandbyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, SsoService_StandbyFacebookLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SsoServiceServer interface {
	...
	GoogleLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error)
	FacebookLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error)
	GithubLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error)
	StandbyGoogleLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error)
	StandbyFacebookLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error)
	// 注册
...
func (UnimplementedSsoServiceServer) GoogleLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GoogleLogin not implemented")
}
func (UnimplementedSsoServiceServer) FacebookLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FacebookLogin not implemented")
}
func (UnimplementedSsoServiceServer) GithubLogin(context.Context, *ThirdPartyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GithubLogin not implemented")
}
func (UnimplementedSsoServiceServer) StandbyGoogleLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StandbyGoogleLogin not implemented")
}
func (UnimplementedSsoServiceServer) StandbyFacebookLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StandbyFacebookLogin not implemented")
}
...
func _SsoService_GoogleLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).GoogleLogin(ctx, req.(*ThirdPartyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SsoService_FacebookLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ThirdPartyLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SsoServiceServer).FacebookLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SsoService_FacebookLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).FacebookLogin(ctx, req.(*ThirdPartyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SsoService_GithubLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).GithubLogin(ctx, req.(*ThirdPartyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SsoService_StandbyGoogleLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StandbyLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SsoServiceServer).StandbyGoogleLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SsoService_StandbyGoogleLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).StandbyGoogleLogin(ctx, req.(*StandbyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SsoService_StandbyFacebookLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StandbyLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SsoServiceServer).StandbyFacebookLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SsoService_StandbyFacebookLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).StandbyFacebookLogin(ctx, req.(*StandbyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SsoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SsoService_FacebookLogin_Handler,
		},
		{
		...
		{
			MethodName: "StandbyGoogleLogin",
			Handler:    _SsoService_StandbyGoogleLogin_Handler,
		},
		{
			MethodName: "StandbyFacebookLogin",
			Handler:    _SsoService_StandbyFacebookLogin_Handler,
		},
		{
