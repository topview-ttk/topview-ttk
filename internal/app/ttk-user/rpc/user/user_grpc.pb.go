...
const (
	...
	SsoService_StandbyLogin_FullMethodName              = "/user.SsoService/StandbyLogin"
...
func (c *ssoServiceClient) StandbyLogin(ctx context.Context, in *StandbyLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, SsoService_StandbyLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SsoServiceServer interface {
	...
	StandbyLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error)
	// 注册
...
func (UnimplementedSsoServiceServer) StandbyLogin(context.Context, *StandbyLoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StandbyLogin not implemented")
}
...
func _SsoService_StandbyLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StandbyLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SsoServiceServer).StandbyLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SsoService_StandbyLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SsoServiceServer).StandbyLogin(ctx, req.(*StandbyLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SsoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StandbyLogin",
			Handler:    _SsoService_StandbyLogin_Handler,
		},
		{
